...
This module provides tools for analyzing and validating LinkedIn post.
"""
...
def count_characters(text: str, tool_context: ToolContext) -> Dict[str, Any]:
    ...
    Args:
        test: The text to analyse for character count
        tool_context: Context for accessing and updating session state

    Returns:
        Dict[str, Any]: Dictionary containing:
            - result: 'fail' or 'pass'
            - char_count : number of chracters in text
    ...
    if char_count < MIN_LENGTH:
        ...
        return {
            "result" : "fail",
            "chat_count" : char_count,
            "chars_needed": chars_needed,
            "message": f"Post is too short. Add {chars_needed} more chracters to reach minimum length of {MIN_LENGTH}.",
        }
        ...
        return {
            ...
            "char_to_remove": chars_to_remove,
            "message": f"Post is too long. Remove {chars_to_remove} chracters to meet maximum length of {MAX_LENGTH}.",
        }
    else:
...
def exit_loop(tool_context: ToolContext) -> Dict[str, Any]:
    ...
    signalling the iterative process should end.

    Args:
        tool_context:n Context for tool execution
    ...
    print("\n-------------EXIT LOOP TRIGGERED ------------")
    print("Post review completed sucessfully")
